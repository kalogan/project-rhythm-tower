...
import summitRaw from './packs/pack.summit.json' with { type: 'json' };
import belfryRaw from './packs/pack.belfry.json' with { type: 'json' };
 ...
 */
const RAW_PACKS: unknown[] = [atriumRaw, spireRaw, verdantRaw, summitRaw, belfryRaw];
